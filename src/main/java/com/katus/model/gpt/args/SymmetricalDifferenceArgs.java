...
@Setter
@Slf4j
public class SymmetricalDifferenceArgs {
    ...
    public static SymmetricalDifferenceArgs initArgs(String[] args) {
        SymmetricalDifferenceArgs mArgs = new SymmetricalDifferenceArgs();
